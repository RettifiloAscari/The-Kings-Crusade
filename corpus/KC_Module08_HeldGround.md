<!-- GENERATED FILE - DO NOT EDIT.
     Source:     scripts/KC_Module08_HeldGround.js
...
Vindana’s occupation-era grain levy records — thousands of receipts, quotas, and permits, exactly the bureaucracy Module Three showed the party in miniature — have fallen into coalition hands whole, and nobody sent to sort them was remotely prepared for the scale of it.

> *Three different coalition quartermasters are shouting at each other over a single warehouse of requisitioned grain, each one certain their own contingent’s paperwork takes precedence, while an increasingly desperate Elduvish clerk — pressed into the coalition’s service rather than freed from it, which nobody seems to have noticed yet — tries to explain that the numbers do not actually add up for anyone.*

Let the party resolve this however they find funniest: mediate, cut through it with authority, or simply steal a wagon of grain themselves while the argument continues. No mechanical stakes and no wrong answer. If a perceptive party notices the pressed clerk’s situation and does something about it — a small kindness, not a rescue — let that pay forward into how Elduvaine’s ordinary people regard the coalition later.
...
## A Quiet Word With the Ward

If the Ward was rescued in Module Four, let her and the Magistrate meet for the first time here — two members of a divided royal house with different ideas about what should follow the war, meeting in a moment that has no pressure on it yet. Play their first exchange for warmth and a little friction, not conflict; save the real disagreement for later in the campaign, per the royal house’s established canon division on the question.

# Diverging Paths (DM Only)

- **How the Magistrate was freed.** Caper or force — track which. A caper leaves the occupation’s administration none the wiser for a while longer, which a DM can use later; a forced rescue is noisier and gives the coalition’s presence in Vindana a slightly harder edge sooner.
- **Whether the party noticed the pressed clerk in Scene 2.** A small thread, but worth tracking — it is the campaign’s recurring question about the occupation’s ordinary people, in miniature, again.

# Loot

- **The Magistrate herself.** As with the Ward in Module Four, the module’s actual reward — a second freed royal, formidable in her own register, and a second real voice in whatever the royal house eventually decides about Elduvaine’s future.
- **A warehouse’s worth of grain.** However the Grain Ledger War was resolved, the coalition ends this module better supplied than it started it — modest, practical, not a coin windfall.
