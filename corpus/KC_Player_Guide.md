<!-- GENERATED FILE - DO NOT EDIT.
     Source:     scripts/KC_Player_Guide.js
...
Build your character against the world as described here. Let your DM fill in the rest at the table, as your character actually learns it.

# The Call

Three years ago, the roads out of Elduvaine stopped keeping their old habits, and then stopped carrying anything at all. What little came out after that arrived on foot, thin, and reluctant to talk about what it had seen. The story that eventually settled was this: Elduvaine did not fall to an invasion. It fell to one of its own — a man named Maedoc Vale, who had spent nineteen years as Keeper of the great Archive at Caer Ysolde, and who one night opened every ward he had sworn to maintain and let an army walk in through the gap. Nobody who tells this story claims to know why he did it. He has not explained himself to anyone still able to ask.

The royal house is taken, or scattered, or in hiding — accounts differ, and the truth is likely all three at once. The land itself, which in Elduvaine has never been ordinary, is reportedly failing in patches, the way a body fails when something is being taken from it faster than it can be replaced.

King Xavier III of Harrowmark has called a crusade, and — unusually for a king — is leading it himself. Two other powers march under the same call: the Kingdom of Oksitan and the Grand Duchy of Auberitz, each for reasons of their own that they have been perfectly willing to state and perfectly unwilling to fully explain. A third, the Kingdom of Norvatch, has taken no side and made no promises, and deals with whoever is useful to it.

You are not part of the army. You are what a king sends ahead of one: four to six people who can move faster than a column of thousands, go where it cannot, and be denied more plausibly if caught somewhere they should not be. Xavier chose this party himself, and remembers names.

> *The march to Elduvaine is long, and your DM is not rushing you through it. Expect the road itself — the realms you cross, the people you meet on the way, the ordinary difficulty of moving anywhere with an army behind you — to be as much a part of this campaign as anything you eventually find at the other end of it.*
...
None of the three visiting powers is marching purely for Elduvaine’s sake, and none of them pretends otherwise to anyone who asks directly. What each of them actually wants out of a won war is not something your character would know yet — only that they all, plainly, want something.

# The Promise

A crusade this size is not raised on sympathy alone, and Xavier did not ask anyone to march for nothing. The terms offered to those who answer the call are simple to state and enormous in practice: a share of Elduvaine’s own magic — land inside the Living Realm itself, where the old habits are said to work — and access to the Ysolde Archive, reputed to be the largest single collection of magical knowledge anywhere in the world.

Both promises depend on one thing neither Xavier nor anyone else can currently guarantee: that Elduvaine is actually taken, and actually held, by the time the war ends. Your character may be marching for the promise itself, for reasons that have nothing to do with it, or for some mixture the player hasn’t fully worked out yet — all three are equally valid places to start.
...
Xavier picked this party in person, which means he had a reason for each of you, even if that reason was never fully explained. Some possibilities, freely mixed or discarded:

- You did something in Harrowmark’s service — killed a wyvern nobody else would go near, held a hill fort, solved a problem quietly enough that only the king heard about it.
- You came recommended by someone Xavier trusts, and have never quite worked out whether that recommendation was earned or simply convenient.
- You are from one of the allied realms and were attached to this party for reasons your own court explained to you only partially.
- You have a stake in Elduvaine itself — a half-remembered family story, an old debt, a promise made to someone who never came back from there — that has nothing to do with the Promise and everything to do with why you said yes.
- You simply wanted to see a place people say is strange in ways nowhere else is, before whatever is happening to it finishes happening.

You do not need to have this fully decided before the first session. Some of the best answers arrive during play, once your character has actually seen the road.

# Songs of the Muster

Every column marches to something. Harrowmark’s troops, and by now most of the coalition’s, have taken up a single verse said to date back to the muster at Duncarrow itself — sung, murmured, or simply thought at the end of a hard day, and by soldiers who could not tell you who wrote it first.
...
Your DM may close a session with it. If they do, it is worth listening to properly — it is the same four lines every time, and that is exactly the point of it.

# What You Carry

You are leaving a cold, ordinary, thoroughly explicable kingdom to march toward one that, by every account, is neither cold nor ordinary nor explicable — and that is currently being taken apart by a man nobody can adequately explain either. The road between the two is long enough that you will be a different person by the time you reach the end of it. That is not a warning. It is the whole point of going.
