...
c.push(P("Whatever the party learned in Module Six \u2014 the Ward\u2019s knowledge of a postern gate, a garrison officer\u2019s captured dispatch, or simply patient scouting since \u2014 now pays off. Vindana\u2019s defence has a real seam, and finding it precisely is this scene\u2019s job."));

c.push(BOX("The postern gate is exactly where the Ward said it would be, half-hidden behind a repair to the sea wall that was never quite finished \u2014 a door built for a peacetime harbour, not a siege, and evidently forgotten by a garrison that has had three years to fortify everything it remembered to fortify."));
...
// -------------------------------------------------------------- Skill DCs
c.push(H3("Stat Blocks and Scaling"));

c.push(P("Everything the party fights in this module is already printed elsewhere: the Legionary of the Sixth, the Legion Optio and the Legion Ironshank are in the Bestiary, and Marshal Ossian Drell is in Module Six. The dragon is not a stat block by design \u2014 see Scene 3."));
...
c.push(BOX("Above the chaos, unmistakably, a single wyvern climbs hard toward the thing crossing the sky, and even at this distance there is no doubt at all whose banner-colours are on its rider."));
...
c.push(P("The city\u2019s defence comes apart within the hour. This scene is aftermath, not more combat \u2014 let the party walk through a city changing hands in real time: garrison soldiers surrendering in ones and twos, Vindana\u2019s own people emerging cautiously from wherever they sheltered, and a coalition that has just watched something it will be telling stories about for the rest of its life."));
...
c.push(ORD("The Stone Comes Down.", "Nine months of Auberitz engineering resolves in about ninety seconds. Forty feet of the inner wall \u2014 Standing Light stone, six centuries old, dark now \u2014 goes over outward, and the noise arrives after the sight of it, and for a moment nobody on either side does anything at all."));
...
c.push(ORD("The Race.", "The coalition storming party and the garrison\u2019s reserve are both running for the breach and the garrison is closer. Unless the party opened the under-wall route in Module Six, in which case they are already inside and behind the reserve, and this phase is theirs to wreck."));

c.push(ORD("The Fight in the Gap.", "Four to six legionaries and an ironshank holding rubble against a party at 5th level. Terrain is the whole encounter: broken stone, three levels of it, and a twenty-foot drop into the ditch on the wrong side. Morale breaks when the ironshank goes down, and the Sixth withdraws in good order and takes its wounded."));

c.push(ORD("The Dragon.", "Overhead, on the third pass, and the module\u2019s other set piece begins. See the puzzle above."));
...
c.push(BUL("The garrison\u2019s stores and armoury.", "Substantial \u2014 Vindana was well-supplied for a long siege it did not get to fight. The first genuinely significant material reward of the campaign; a DM may introduce one uncommon magic item here without it feeling out of place for the first time."));
