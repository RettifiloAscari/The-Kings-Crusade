#!/usr/bin/env bash
#
# Regenerate the entire corpus from the generator scripts.
#
...
GENERATORS=(KC_Sourcebook KC_Module01_TheMuster KC_Module02A_TheSeaRoad KC_Module02B_TheMountainRoad KC_Module03_Landfall KC_Module04_TheCoalition KC_Module05_TheRoadToVindana KC_Module06_VindanaInvestment KC_Module07_VindanaBreaking KC_Module08_HeldGround)
